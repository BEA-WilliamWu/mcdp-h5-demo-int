...
INSERT ALL
  ...
  VALUES
    ('HTH_USER_ACCESS_LOCAL_REPOSITORY_ADAPTER', 'repositoryadapterconfig',
     'com.ofss.digx.cz.bea.domain.hosttohost.entity.repository.adapter.LocalHthUserAccessRepositoryAdapter',
     'N', NULL, NULL, 'ofssuser', SYSDATE, 'ofssuser', SYSDATE,
     NULL, NULL, 'N', NULL)
  INTO DIGX_FW_CONFIG_ALL_B
    (PROP_ID, CATEGORY_ID, PROP_VALUE, FACTORY_SHIPPED_FLAG, PROP_COMMENTS,
     SUMMARY_TEXT, CREATED_BY, CREATION_DATE, LAST_UPDATED_BY,
...
INSERT ALL
  ...
  VALUES
    ('HTH_USER_ACCESS_LOCAL_REPOSITORY_ADAPTER', 'RepositoryAdapterFactories',
     'com.ofss.digx.cz.bea.domain.hosttohost.entity.repository.adapter.LocalHthUserAccessRepositoryAdapter',
