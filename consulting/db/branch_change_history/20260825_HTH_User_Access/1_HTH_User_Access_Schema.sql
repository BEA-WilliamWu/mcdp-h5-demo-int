...
-- Effective Current and Savings account grants by HTH user and account-owning party.
CREATE TABLE HTH_BEA.HTH_USER_ACCESS_ACCOUNT (
  ...
  CONSTRAINT UK_HTH_UA_ACCOUNT UNIQUE
    (PARTY_ID, CLOSE_ID, ACCESS_PARTY_ID, LINKAGE_TYPE, ACCOUNT_NUMBER),
...
COMMENT ON COLUMN HTH_BEA.HTH_USER_ACCESS_REQ_ACCOUNT.ACCOUNT_TYPE IS
  'Account type captured at submit time; only CSA is supported.';
