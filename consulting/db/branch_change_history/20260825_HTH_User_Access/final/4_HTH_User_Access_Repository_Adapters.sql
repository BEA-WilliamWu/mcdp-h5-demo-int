...
-- Legacy REQUEST adapter keys remain in the DELETE lists so re-running this script also cleans
-- environments deployed before request tables were removed. Only the two effective-grant adapters
-- are registered; approval state is read from DIGX_AP_TRANSACTION.transactionSnapshot.
