...
public final class HthApiPasswordRepositoryTest {
  ...
  public static void main(String[] args) throws java.lang.Exception {
    ...
    if (calls != 19 || statements != calls) {
      throw new AssertionError("Expected 19 adapter calls/statements: " + calls + "/" + statements);
    }
    System.out.println("PASS: 19 adapter calls; complete parameter bindings; no session or transaction ownership changes");
  }
}
