...
public class HthCRMApprovalTest {
    public static void main(String[] args) {
        ...
        HthCRMApproval.committed(null,transaction,"APPROVE");
        ...
        HthCRMApproval.committed(null,transaction,"REJECT");
        ...
        if(com.ofss.digx.cz.bea.common.hth.HthChannelSupport.isHthApproval("other.HostToHostManagement.submit",null))throw new AssertionError("loose service match");
